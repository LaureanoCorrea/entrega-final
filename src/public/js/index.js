document.addEventListener("DOMContentLoaded", function () {
  ...
  function addProduct(event) {
    ...
    // Obtener el correo electrónico del usuario (puedes obtenerlo de donde lo tengas guardado)
    ...
    if (!title || !price || !thumbnail || !code || !stock || !category || !status) {
      Swal.fire({
        icon: "error",
        title: "Error",
  ...
  window.borrarProducto = (id) => {
    socket.emit("deleteProduct", { productId: id, userRole, userEmail });
  };
